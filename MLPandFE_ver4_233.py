...
def feature_engineering(is_train=True):
    ...
    df['totalDistance'] = df['rideDistance']/9 + df["walkDistance"] + df["swimDistance"]*0.4
    ...
    df['getItems'] = df['boosts'] + df['heals']*0.2 + df['weaponsAcquired']*0.8
    df['totalTime'] = (df['walkDistance']/8 + df['rideDistance']/70 + df['swimDistance']/8 + df['heals']*7 + df['boosts']*11 + df['weaponsAcquired']*10)/df['matchDuration']
    df['teamWork'] = df['DBNOs']*0.5 + df['assists']*1.2 + df['revives'] - df['teamKills']*0.1
