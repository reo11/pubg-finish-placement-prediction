...
def feature_engineering(is_train=True):
    ...
    df['totalTime'] = df['walkDistance']/8 + df['rideDistance']/70 + df['swimDistance']/8 + df['heals']*7 + df['boosts']*11 + df['weaponsAcquired']*10
    df['df'] = df['DBNOs']*0.5 + df['assists']*1.2 + df['revives'] - df['teamKills']*0.1
    # df['totalTime_over_']
